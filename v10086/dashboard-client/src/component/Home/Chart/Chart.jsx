...
export default function Chart(props) {
  ...
  useEffect( () => {
    window.ApexCharts.exec('home-chart','updateSeries',series)
  ...
  return (
    <div className={classes.root}>
      ...
      <ButtonGroup color="primary" className={classes.rangeBtnGroup} id="home-range-btn">
        <Button className={props.range === '年' ? classes.btnActive : classes.btn} onClick={() => props.handleRange('年')}>年</Button>
        <Button className={props.range === '月' ? classes.btnActive : classes.btn} onClick={() => props.handleRange('月')}>月</Button>
        <Button className={props.range === '日' ? classes.btnActive : classes.btn} onClick={() => props.handleRange('日')}>日</Button>
      </ButtonGroup>
